...
/**
 * This class will verify a roman numeral based on four principles
 * first, to see if there is only valid roman characters
 * no more than three of the same roman numerals can repeate in a sequence
 * a smaller roman numeral may appear immediately left of a roman numeral only if
 * the value of the smaller is less than or equal to 10 times the larger. 
 * only roman numerals that are a power of 10 may appear immediately in front of a larger number.
 * @author Daniel Son
 *
 */
...
//        }    
	 ...
	 */
	public boolean checkIndividualChar(char[] input)
	{
	 ...
	 */
	public boolean checkThreeOrMoreNumerals(char[] input)
	{
		CharacterQueue numeralQueue = new CharacterQueue();
	 ...
	 */
	public boolean checkDuplicatesValidTens(char[] input)
	{
		CharacterQueue numeralQueue = new CharacterQueue();
	 ...
	 */
	public boolean checkPowerLeftOfNumeral(char[] input)
	{
		CharacterQueue numeralQueue = new CharacterQueue();
	 ...
	 */
	public boolean checkPowerFrontOfNumeral(char[] input)
	{
		CharacterQueue numeralQueue = new CharacterQueue();
